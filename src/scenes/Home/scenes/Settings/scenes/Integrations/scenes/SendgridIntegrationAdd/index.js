...
class SendgridIntegrationAdd extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (<Grid container spacing={2}>
      <Grid item xs={12} sm={12} md={8}>
        <Card className="integration-item-form-container">
          <CardContent>
            <h5>How to integrate SendGrid</h5>
            <ul className="guide">
  ...
  _submitIntegration = () => {
    if (
      ...
      this.props.saveIntegration('SendGrid', false, parameters, 'SendGrid');
    ...
    return (
      ...
      onClose={this.props.onClose}>
        <DialogContent className="dialog-integration-container">
          <h4 className="title">Connect SendGrid</h4>
...
SendgridIntegrationAdd.propTypes = {
