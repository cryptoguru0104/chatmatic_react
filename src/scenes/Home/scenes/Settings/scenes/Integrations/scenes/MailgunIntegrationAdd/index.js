...
class MailgunIntegrationAdd extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (<Grid container spacing={2}>
      <Grid item xs={12} sm={12} md={8}>
        <Card className="integration-item-form-container">
          <CardContent>
            <h5>How to integrate Mailgun</h5>
            <ul className="guide">
              <li>Enter your Mailgun API Key.</li>
            </ul>
            <form className="">
  ...
  _submitIntegration = () => {
    if (
      ...
      this.props.saveIntegration('Mailgun', false, parameters, 'Mailgun');
    ...
    return (
      ...
      onClose={this.props.onClose}>
        <DialogContent className="dialog-integration-container">
          <h4 className="title">Connect Mailgun</h4>
...
MailgunIntegrationAdd.propTypes = {
