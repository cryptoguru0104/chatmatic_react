...
class InlineTextEdit extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            mergeTags: props.type == 'EMAIL' ? defaultEmailMergeTags : defaultMergeTags.concat(
                _(props.mergeTags)
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (mergeTags !== nextProps.mergeTags) {
            this.setState({
                mergeTags: nextProps.type == 'EMAIL' ? defaultEmailMergeTags : defaultMergeTags.concat(
    ...
    render() {
        ...
        return (
            <div className="d-flex position-relative inline-text-edit-container">
                <InlineEdit
                ...
                {(this.props.editing || this.state.editing) && (
                    <div
                        className="d-flex align-items-center position-absolute icons-container"
                        onMouseEnter={() =>
                                    ...
                                    {mergeTags.map((m, i) => (
                                        <DropdownItem key={i}>
                                            <div
                                                onClick={() =>
                                                    this.props.updateItemInfo({
                                                        textMessage: this.props.type == 'EMAIL' ? `${m.mergeTag}` : insertTextAtPos(
                                                            this.props
                                                                .textMessage,
                                                            ` ${m.mergeTag} `,
                                                            this
...
export default connect(mapStateToProps, {})(InlineTextEdit);
